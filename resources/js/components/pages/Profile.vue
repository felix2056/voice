      ...
      <div class="row">
        <div class="col-xl-4 col-lg-5">
          ...
          <div class="box bg-inverse bg-dark bg-hexagons-white">
            <div class="box-body box-profile">
              <img class="profile-user-img rounded-circle img-fluid mx-auto d-block" :src="profile.avatar_url" :alt="profile.name">
              	...
              	<div class="col-12">
              		<div class="profile-user-info">
						...
						<div class="user-social-acount">
							...
							<button class="btn btn-block btn-social btn-linkedin"><i class="fa fa-linkedin"></i> Linkedin</button>
						</div>
        ...
        <div class="col-xl-8 col-lg-7">
          <div class="box box-solid bg-black">
			...
			<!-- /.box-header -->
            <form enctype="multipart/form-data" accept-charset="UTF-8" method="post" @submit.prevent="updateUser">
                <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group row" :class="{ 'has-error': errors.name != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.name" placeholder="Johon">
                                <label v-if="errors.name != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.name) }}
                                </label>
                            </div>
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.email != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="email" v-model="profile.email" disabled placeholder="johone@dummy.com">
                                <label v-if="errors.email != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.email) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.phonenumber != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="tel" v-model="profile.phonenumber" placeholder="123 456 7890">
                                <label v-if="errors.phonenumber != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.phonenumber) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group row" :class="{ 'has-error': errors.street != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.street" placeholder="A-458, Lorem Ipsum, city">
                                <label v-if="errors.street != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.street) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.city != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.city" placeholder="Your City">
                                <label v-if="errors.city != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.city) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.state != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.state" placeholder="Your State">
                                <label v-if="errors.state != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.state) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.postalcode != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="number" v-model="profile.postalcode" placeholder="123456">
                                <label v-if="errors.postalcode != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.postalcode) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group row" :class="{ 'has-error': errors.facebook != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.facebook" placeholder="facebook id">
                                <label v-if="errors.facebook != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.facebook) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.instagram != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.instagram" placeholder="instagram id">
                                <label v-if="errors.instagram != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.instagram) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.twitter != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.twitter" placeholder="twitter id">
                                <label v-if="errors.twitter != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.twitter) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
                        ...
                        <div class="form-group row" :class="{ 'has-error': errors.linkedin != '' }">
                            ...
                            <div v-if="user.id == profile.id" class="col-sm-10">
                                <input class="form-control" type="text" v-model="profile.linkedin" placeholder="linkedin id">
                                <label v-if="errors.linkedin != ''" class="control-label" for="inputError">
                                    <i class="fa fa-times-circle-o"></i> {{ String(errors.linkedin) }}
                                </label>
                            </div>
                            <div v-else class="col-sm-10">
...
export default {
    ...
    methods: {
        ...
        async updateUser() {
            ...
            data.street = this.profile.street;
            data.city = this.profile.city;
            data.state = this.profile.state;
            data.postalcode = this.profile.postalcode;
